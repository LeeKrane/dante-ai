...
function sessionsBlock(kinds) {
  ...
  lines.push(
    ...
    'end with "Shall I, sir?". When the machine-state line already shows that session as blocked,',
    "do not propose a watch on it - say it is already blocked and waiting on a permission, since a",
    "watch only ever fires on a FRESH transition into blocked and one already in progress is not",
    "news to it.",
    ...
    "and cannot answer three questions at once. The question is the interview: it begins with",
    'the first one you ask, so never announce it or preface it - no "before I interview", no',
    '"first, a question", no lead-in of any kind - the reply is the question, then the tag.',
    "Append",
