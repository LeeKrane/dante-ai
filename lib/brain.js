...
function sessionsBlock(kinds) {
  ...
  const lines = [
    ...
    "The repo alias is one word - the name he calls that repository. The task is a sentence,",
    "in double quotes, saying what the session should do; pass on what he asked for rather than",
    "summarising it away.",
