...
function sessionsBlock(kinds) {
  ...
  lines.push(
    ...
    "Krane asked you, in this turn, to interrupt that session right now. A session appearing in",
    ...
    "A start, tell, interrupt or stop tag is a PROPOSAL, not an act. Krane is asked to confirm it",
