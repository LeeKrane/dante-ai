...
function sessionsBlock(kinds) {
  ...
  lines.push(
    ...
    "Always wrap it in double quotes, the same rule the builds block gives for any value containing",
    "a space: a session Jesse started by hand is named by whoever typed it, not by Dante, and a name",
    'like name="bug-hunt, completeness-sweep" carries spaces and commas that an unquoted value would',
    "split on.",
