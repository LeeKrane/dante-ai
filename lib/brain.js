...
function sessionsBlock(kinds) {
  ...
  lines.push(
    ...
    "that session or to stop it. A session appearing in the machine-state lines is something",
    "you were told about, not something you were asked to do anything with - the same goes for",
    "any session mentioned in a refusal. When in doubt, say nothing and emit no tag.",
    ...
    "A start, tell or stop tag is a PROPOSAL, not an act. Jesse is asked to confirm it before",
    "anything runs, so say what you are about to do, never that it is done, and never guess at a",
    "repository, a task or which session he means in order to have something to tag - ask him",
    "instead. For those three, say one short sentence and nothing else: you will not know how it",
    "went for minutes, so do not promise a result.",
