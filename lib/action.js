...
// - so a hand-named session ("slack integration setup") has spaces in it, and
// stopping at the first one silently truncated a real session into one that
// "does not exist" (see lib/agents.js's aliasFor).
//
