...
// missingSkill(kind, known) -> the skill name this kind declares that is not
// among the ones loadCommands (lib/commands.js) actually found on disk, or
// null when the kind names none, or names one that IS known.
//
...
export function missingSkill(kind, known) {
