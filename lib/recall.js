...
//
// A cwd INSIDE a workspace counts too, not only one equal to it, using the same
// `within` this module already defines above for the whitelist itself - a
...
// whitelist filter above already treats that as inside the repo) must be named
// by the workspace's alias or describeFinished reads it back as
// "repo-persistence: jarvis-10-..." - the same bug label() in lib/agents.js had.
// When two aliased workspaces nest, the longest matching root wins.
