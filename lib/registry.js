...
// Loads every *.mjs in the directory into a Map keyed by primitive id, via the
// mechanism shared with lib/sessions.js (lib/module-dir.js): the trailing-
// slash handling, the "_"/dotfile skip, and the per-file import/validate/id-
// match rules all live there now.
export async function loadRegistry(dirUrl = DEFAULT_DIR) {
  return loadModuleDir(dirUrl, {
    label: "loadRegistry",
    dirNoun: "primitives directory",
    itemNoun: "a primitive",
