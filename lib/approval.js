...
//
// Sessions jarvis starts run under your own permissions, which is the decision
...
// without jarvis -- the session's own permission prompt -- so the failure mode
...
const YES_PHRASES = [/\bgo ahead\b/, /\bgo for it\b/, /\bdo it\b/, /\bplease do\b/, /\bfine by me\b/];
const NO_PHRASES = [/\bdo not\b/, /\bno way\b/, /\bhold off\b/, /\bleave it\b/, /\bforget it\b/];
